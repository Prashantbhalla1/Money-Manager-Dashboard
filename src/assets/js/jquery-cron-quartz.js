...
(function($) {
    ...
    var cronInputs={
        period: '<div class="cron-select-period form-inline"><label></label><select class="cron-period-select form-control col-lg-4"></select></div>',
        startTime: '<div class="cron-input cron-start-time form-inline">Start time <select class="cron-clock-hour form-control col-lg-2"></select>:<select class="cron-clock-minute  form-control col-lg-2"></select></div>',
        container: '<div class="cron-input"></div>',
        minutes: {
            tag: 'cron-minutes',
            inputs: [ '<p class="form-inline">Every <select class="cron-minutes-select form-control col-lg-4"></select> minutes(s)</p>' ]
        },
        hourly: {
            tag: 'cron-hourly',
            inputs: [ '<p class="form-inline"><input type="radio" name="hourlyType" value="every"> Every <select class="cron-hourly-select form-control col-lg-4"></select> hour(s)</p>',
                '<p class="form-inline"><input type="radio" name="hourlyType" value="clock"> Every day at <select class="cron-hourly-hour form-control col-lg-2"></select>:<select class="cron-hourly-minute form-control col-lg-2"></select></p>']
        },
        daily: {
            tag: 'cron-daily',
            inputs: [ '<p class="form-inline"><input type="radio" name="dailyType" value="every"> Every <select class="cron-daily-select form-control col-lg-1"></select> day(s)</p>',
                '<p class="form-inline"><input type="radio" name="dailyType" value="clock"> Every week day</p>']
        },
        weekly: {
            tag: 'cron-weekly',
            inputs: [ '<p class="form-inline"><input type="checkbox" name="dayOfWeekMon"> Monday  <input type="checkbox" name="dayOfWeekTue" class="weeklyCheckbox"> Tuesday  '+ 
                '<input type="checkbox" name="dayOfWeekWed" class="weeklyCheckbox"> Wednesday  <input type="checkbox" name="dayOfWeekThu" class="weeklyCheckbox"> Thursday'+ 
                '<input type="checkbox" name="dayOfWeekFri"> Friday  <input type="checkbox" name="dayOfWeekSat"> Saturday  '+ 
                '<input type="checkbox" name="dayOfWeekSun" class="weeklyCheckbox"> Sunday</p>' ]
        },
        monthly: {
            tag: 'cron-monthly',
            inputs: [ '<p class="form-inline"><input type="radio" name="monthlyType" value="byDay"> Day <select class="cron-monthly-day  form-control col-lg-4"></select> of every <select class="cron-monthly-month form-control col-lg-4"></select> month(s)</p>',
                '<p class="form-inline"><input type="radio" name="monthlyType" value="byWeek"> The <select class="cron-monthly-nth-day form-control col-lg-3"></select> ' + 
                '<select class="cron-monthly-day-of-week form-control col-lg-3"></select> of every <select class="cron-monthly-month-by-week form-control col-lg-2"></select> month(s)</p>']
        },
        yearly: {
            tag: 'cron-yearly',
            inputs: [ '<p class="form-inline"><input type="radio" name="yearlyType" value="byDay"> Every <select class="cron-yearly-month form-control col-lg-3"></select> <select class="cron-yearly-day form-control col-lg-3"></select></p>',
                '<p class="form-inline"><input type="radio" name="yearlyType" value="byWeek"> The <select class="cron-yearly-nth-day form-control col-lg-3"></select> ' + 
                '<select class="cron-yearly-day-of-week form-control col-lg-3"></select> of <select class="cron-yearly-month-by-week form-control col-lg-3"></select></p>']
        }
    };
